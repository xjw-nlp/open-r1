...
from seqrec_utils import *
from collator import TestCollator
from prompt import all_prompt
from seqrec_evaluate import get_topk_results, get_metrics_results
# import os
...
def test_ddp(args):
    ...
    if args.lora:
        ...
        # breakpoint()
        model.original_vocab_size = len(base_tokenizer)
    ...
    test_data = load_test_dataset(args, tokenizer=tokenizer)
    ...
    with torch.no_grad():
        ...
        for prompt_id in prompt_ids:
            ...
            for step, batch in enumerate(tqdm(test_loader)):
                ...
                # if 'cot' in args.test_task.lower():
                #     for idx, ans in enumerate(output):
                #         output[idx] = ans.split('</think>')[-1].strip()
